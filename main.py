...
from const import RED, BLACK, WHITE
...
pygame.time.set_timer(CREATE_BONUSES, 2500)
...
while is_working:
    ...
    for event in pygame.event.get():
        ...
        if event.type == CREATE_ENEMY:
            enemies.append(created_enemy())

        if event.type == CREATE_BONUSES:
            bonuses.append(created_bonuses())
    ...
    main_surface.blit(font.render(str(f'Scores: {scores}'), True, RED), (width - 100, 0))
